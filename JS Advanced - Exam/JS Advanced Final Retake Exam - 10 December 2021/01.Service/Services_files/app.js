...
function solve() {
    ...
    function sendForm(e) {
        ...
        finishtBtn.addEventListener('click', () => {
            ...
            h2El2.textContent = `Product type for repair: ${productTypeField.value}`;
            h3El2.textContent = `Client information: ${clientNameField.value}, ${clientPhoneField.value}`;
            h4El2.textContent = `Description of the problem: ${descriptionField.value}`;
            divEl2.appendChild(h2El2);
            divEl2.appendChild(h3El2);
            divEl2.appendChild(h4El2);

            completedOrdersField.appendChild(divEl2);
